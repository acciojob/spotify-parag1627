...
//
//    public Album createAlbum(String title, String artistName) {
//      Artist artist = spotifyRepository.findArtist(artistName);
//      if(artist == null){
//          artist= spotifyRepository.createArtist(artistName);
//      }
//      return spotifyRepository.createAlbum(title,artist);
//    }
//
//    public Song createSong(String title, String albumName, int length) throws Exception {
//
